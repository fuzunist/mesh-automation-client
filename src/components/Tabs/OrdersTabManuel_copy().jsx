...
const OrdersTabManuel = ({ enableKesmeTab }) => {
  ...
  const handleSortByHeightStick = (orderListParam = orderList) => {
    ...
    const sortedData = [...listToSort].sort((a, b) => {
      // Primary sorting by mesh code
      if (a.order_details.information.mesh_code !== b.order_details.information.mesh_code) {
        return a.order_details.information.mesh_code.localeCompare(b.order_details.information.mesh_code);
      }

      // Secondary sorting by mesh name (numeric part)
      ...
      // Tertiary sorting by length of height stick
      if (
      ...
      // Quaternary sorting by maximum of front and back filament
      if (
        Math.max(
      ...
      // Quinary sorting by length of width stick
      return (
